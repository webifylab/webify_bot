...
bot.on('message', (msg) => {
    ...
    if(text === '/start'){
        ...
        bot.sendMessage(
            chatId,
            'Мы новая веб-студия, занимаемся веб-услугами, такие как:\n1. Создание сайтов на тильда, wordpress и webflow.\n2. Создание дизайнов сайта.\n3. Разработка сайтов (HTML, CSS, JavaScript, React)'
        )
